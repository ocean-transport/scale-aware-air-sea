        ...
        "paths": {
            model: {
                ...
                "plotting": {
                    ...
                    "full_fluxes": {
                        k: {
                            kk: f"{bucket}/{version_full}/plotting/{model}_full_flux_{k}_{kk}.zarr"
                            for kk in ["global_mean", "time_mean"]
                        }
                        for k in ["online", "offline"]
                    },
                    "histogram": {
                        var: f"{bucket}/{version_full}/plotting/{model}_histogram_{var}.zarr"
                ...
                "plotting_pub": {
                    ...
                    "full_fluxes": {
                        k: {
                            kk: f"{bucket_pub}/{version_full}/plotting/{model}_full_flux_{k}_{kk}.zarr"
                            for kk in ["global_mean", "time_mean"]
                        }
                        for k in ["online", "offline"]
                    },
                    "histogram": {
                        var: f"{bucket_pub}/{version_full}/plotting/{model}_histogram_{var}.zarr"
                        for var in ["q_total", "ql", "qh"]
                    },
                },
            }
